...
public class TestWebClient
{
    ...
    public void testGetContentOk()
        throws Exception
    {
        String result = client.getContent( new URL( "http://localhost:9200/testGetContentOk" ) );
    ...
    public void testGetContentError()
        throws Exception
    {
        String result = client.getContent( new URL( "http://localhost:9200/testGetContentError/" ) );
        assertNull( result );
    }
    ...
    public void testGetContentNotFound()
        throws Exception
    {
        String result = client.getContent( new URL( "http://localhost:9200/testGetContentNotFound" ) );
        assertNull( result );
    }
